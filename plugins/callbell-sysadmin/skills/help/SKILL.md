...
Die Skills tragen den Packnamen nicht im eigenen Namen, der Namensraum `callbell-sysadmin:` trennt sie
bereits. Codex nutzt dieselben Skills mit dem Präfix `@`. Der Kern liegt darunter und ist Voraussetzung:
`/callbell:help` zeigt dessen Karte.
