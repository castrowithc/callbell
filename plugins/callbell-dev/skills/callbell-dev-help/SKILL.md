...
|-------|--------|-----------------|
| **lite** | `/callbell-dev lite` | Bau, was verlangt ist, nenn die faulere Alternative in einer Zeile. |
...
|-------|--------|------------|
| **dev** | `/callbell-dev` | Der Faul-Modus selbst. Die einfachste Lösung, die funktioniert. |
